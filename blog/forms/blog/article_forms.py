    ...
    class Meta:
        ...
        widgets = {
            ...
            'image_credit': TextInput(attrs={
                'name': "image_credit",
                'class': "form-control",
                'placeholder': "Example: made4dev (Premium programming T-shirts",
                'id': "image_credit"
            }),
            ...
            'status': Select(choices=STATUS_CHOICES, attrs={
                'class': "form-control selectpicker",
    ...
    class Meta:
        ...
        widgets = {
            ...
            'image_credit': TextInput(attrs={
                'name': "image_credit",
                'class': "form-control",
                'placeholder': "Example: study.com (Premium Programming T-Shirts)",
                'id': "image_credit"
            }),
            'status': Select(choices=STATUS_CHOICES, attrs={
                "class": "form-control selectpicker",
